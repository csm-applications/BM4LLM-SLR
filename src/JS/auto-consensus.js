let studies = [];
    ...
    document.getElementById('download-btn').addEventListener('click', () => {
      ...
      // 🔹 Também salvar no localStorage (com studyInfo dentro)
      localStorage.setItem("finalDecision", JSON.stringify({
        metadata,
        included,
        excluded
      }, null, 2));
